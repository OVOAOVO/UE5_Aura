...
void UAuraAttributeSet::OnRep_PhysicalResistance(const FGameplayAttributeData& OldPhysiaclResistance) const
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UAuraAttributeSet, PhysicalResistance, OldPhysiaclResistance);
}
